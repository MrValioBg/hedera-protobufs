...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [proto.ResponseHeader](#proto-ResponseHeader) |  | The standard response information for queries. <p> This includes the values requested in the `QueryHeader` (cost, state proof, both, or neither). |
